...
<!--Modal-->
<div bind:this={modal} aria-modal="true" aria-hidden={!show} class="modal {show ? 'opacity-100' : 'opacity-0'} transition-opacity duration-75 ease-in pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
